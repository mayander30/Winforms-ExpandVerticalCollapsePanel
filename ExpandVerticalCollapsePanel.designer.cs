using pControlsDev.Generic;
namespace pControlsDev.Headers.Vertical
{
    partial class ExpandVerticalCollapsePanel
    {
        /// <summary> 
        ...
        {
            this.lblHeader = new pControlsDev.Generic.LabelJosVertical();
            this._btnExpandCollapse = new pControlsDev.Headers.Vertical.ExpandVerticalCollapseButton();
            this.SuspendLayout();
            // 
            // lblHeader
            // 
            ...
            this._btnExpandCollapse.ButtonSize = pControlsDev.Headers.Vertical.ExpandVerticalCollapseButton.ExpandButtonSize.Small;
            this._btnExpandCollapse.ButtonStyle = pControlsDev.Headers.Vertical.ExpandVerticalCollapseButton.ExpandButtonStyle.Normal;
        ...
        private LabelJosVertical lblHeader;
    }
}
